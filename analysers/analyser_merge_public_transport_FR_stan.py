...
class Analyser_Merge_Public_Transport_FR_stan(Analyser_Merge):
    def __init__(self, config, logger = None):
        place = "STAN"
        self.missing_official = {"item":"1052", "class": 91, "level": 2, "tag": ["missing_official", "public transport"], "desc": T_f(u"{0} stop not integrated", place) }
        self.possible_merge   = {"item":"1054", "class": 93, "level": 2, "tag": ["possible_merge", "public transport"], "desc": T_f(u"{0} stop, integration suggestion", place) }
