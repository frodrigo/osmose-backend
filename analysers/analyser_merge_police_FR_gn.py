...
class Analyser_Merge_Police_FR_gn(Analyser_Merge):
    def __init__(self, config, logger = None):
        self.missing_official = {"item":"6072", "class": 1, "level": 3, "tag": ["merge"], "desc": T_(u"Police/\"Gendarmerie\" not integrated") }
        self.possible_merge   = {"item":"6073", "class": 3, "level": 3, "tag": ["merge"], "desc": T_(u"Police/\"Gendarmerie\", integration suggestion") }
        self.update_official  = {"item":"6074", "class": 4, "level": 3, "tag": ["merge"], "desc": T_(u"Police/\"Gendarmerie\" update") }
