...
class Analyser_Merge_Tourism_FR_Aquitaine_Caravan(Analyser_Merge):
    def __init__(self, config, logger = None):
        self.missing_official = {"item":"2052", "class": 1, "level": 3, "tag": ["missing_official", "fix:imagery", "tourism"], "desc": T_(u"Aquitaine caravan site not integrated") }
...
class Analyser_Merge_Tourism_FR_Aquitaine_Camp(Analyser_Merge):
    def __init__(self, config, logger = None):
        self.missing_official = {"item":"2052", "class": 11, "level": 3, "tag": ["missing_official", "fix:imagery", "tourism"], "desc": T_(u"Aquitaine camp site not integrated") }
        Analyser_Merge.__init__(self, config, logger,
